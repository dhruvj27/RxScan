    ...
    return (
        <View className="flex-1 bg-gray-50">
            <ScrollView className="flex-1 p-4">
                {/* Header */}
                <View className="bg-background-0 rounded-lg p-4 mb-4 shadow-sm">
                    <Text className="text-2xl font-bold text-typography-800 text-center mb-2">
                        Text Translator
                    </Text>
                ...
                {/* Language Selection */}
                <View className="bg-background-0 rounded-lg p-4 mb-4 shadow-sm">
                    <Text className="text-lg font-semibold text-typography-800 mb-3">
                        Target Language
                    </Text>
                    <TouchableOpacity
                    ...
                    >
                        <Text className="text-typography-800">{selectedLanguage}</Text>
                ...
                <View className="bg-background-0 rounded-lg p-4 mb-4 shadow-sm">
                    ...
                    <TextInput
                        className="border border-gray-300 rounded-lg p-3 text-typography-800"
                ...
                <View className="bg-background-0 rounded-lg p-4 mb-4 shadow-sm">
                    ...
                    <TextInput
                        className="border border-gray-300 rounded-lg p-3 text-typography-800 min-h-32"
                ...
                {translatedText ? (
                    <View className="bg-background-0 rounded-lg p-4 mb-4 shadow-sm">
                        ...
                        <ScrollView className="max-h-64 border border-gray-300 rounded-lg p-3">
                            <Text className="text-typography-800 leading-6">{translatedText}</Text>
                        </ScrollView>
                    </View>
                ) : null}
            </ScrollView>
            ...
            >
                <View className="flex-1 justify-end bg-black bg-opacity-50">
                    <View className="bg-background-0 rounded-t-lg">
                        ...
                        <ScrollView className="max-h-64">
                            {languages.map((language) => (
                                ...
                                >
                                    <Text className={`text-base ${selectedLanguage === language ? 'text-blue-500 font-semibold' : 'text-typography-800'
                                        }`}>
                                        {language}
                                    </Text>
                                </TouchableOpacity>
                    ...
                    <ScrollView className="flex-1 p-4">
                        ...
                        <View className="mb-6">
                            ...
                            <View className="bg-gray-50 p-4 rounded-lg border-l-4 border-blue-500">
                                <Text className="text-typography-800 leading-6">{inputText}</Text>
                            </View>
                        </View>
