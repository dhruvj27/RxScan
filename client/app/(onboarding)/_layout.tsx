            ...
            <View className="relative">
                ...
                <View className="bg-[#12c388] h-36 rounded-b-[32px] relative overflow-hidden">
                    ...
                    <View className="flex-row items-center justify-between px-6 pt-12 pb-4">
                        <TouchableOpacity
                            onPress={handleBack}
                            className="bg-background-0/20 rounded-full p-2"
                            activeOpacity={0.7}
                            style={{
                                shadowColor: '#000',
                ...
                <View className="px-6 -mt-8 mb-4">
                    <View
                        className="bg-background-0 rounded-3xl p-6 border border-gray-100"
                        style={{
                            shadowColor: '#000',
                    ...
                    >
                        ...
                        <View className="flex-row items-center justify-between mb-4">
                            <View className="flex-row items-center">
                                ...
                                <View>
                                    <Text className="text-typography-900 font-bold text-base">{getStepTitle(currentStep)}</Text>
                                    <Text className="text-typography-500 text-sm">Step {currentStep} of 4</Text>
                                </View>
                            </View>

                            <View className="items-end">
                                <Text className="text-emerald-600 text-lg font-bold">{currentStep * 25}%</Text>
                                <Text className="text-typography-400 text-xs">Complete</Text>
                            </View>
                        </View>
