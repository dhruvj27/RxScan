        ...
        <SafeAreaView className="flex-1 bg-gray-50">
            ...
            >
                <View className="mb-8 pt-4">
                    <View className="flex-row items-center mb-4">
                        ...
                        <View className="flex-1">
                            <Text className="text-2xl font-bold text-typography-900 mb-1">Medical Conditions</Text>
                ...
                <View className="relative mb-6" style={{ zIndex: 1000 }}>
                    <Text className="text-typography-700 font-medium mb-3">Search for medical conditions</Text>
                    <View className="relative">
                        <TextInput
                            ...
                            className="border-2 border-gray-200 rounded-2xl px-4 py-4 pr-12 text-typography-800 bg-background-0 text-base"
                            style={{
                                shadowColor: '#000',
                    ...
                    {showDropdown && (searchText.length > 0 || filteredOptions.length > 0) && (
                        <View
                            className="absolute top-full left-0 right-0 bg-background-0 border-2 border-gray-200 rounded-2xl mt-2"
                            style={{
                                zIndex: 1001,
                                maxHeight: 200,
                                elevation: 8,
                            ...
                            >
                                {filteredOptions.map((option, index) => (
                                    ...
                                    >
                                        ...
                                        <Text className="text-typography-800 text-base">{option}</Text>
                                    </TouchableOpacity>
                                ))}
                                ...
                                {filteredOptions.length === 0 && searchText.length > 0 && (
                                    <View className="px-4 py-6 items-center">
                                        ...
                                        <Text className="text-typography-500 text-center text-base">No matching conditions found</Text>
                                    </View>
                                )}
                            </ScrollView>
                        </View>
                ...
                <View className="mb-8">
                    <View className="flex-row items-center justify-between mb-4">
                        <Text className="text-lg font-semibold text-typography-900">Your Medical Conditions</Text>
                    ...
                    {selectedConditions.length > 0 ? (
                        <View className="bg-background-0 rounded-2xl p-4 border border-gray-200"
                            style={{
                                shadowColor: '#000',
                                shadowOffset: { width: 0, height: 2 },
                                shadowOpacity: 0.05,
                        ...
                        <View className="bg-background-0 rounded-2xl p-6 border border-gray-200 items-center"
                            style={{
                                shadowColor: '#000',
                                shadowOffset: { width: 0, height: 2 },
                                shadowOpacity: 0.05,
                        ...
                        >
                            ...
                            <Text className="text-typography-500 text-center text-base">No medical conditions added yet</Text>
