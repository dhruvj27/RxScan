        ...
        <View className='flex-1 flex'>
            ...
            <View>
                <View className="flex flex-col items-center mt-10">
                    <Text className="text-4xl text-center text-typography-800 font-bold">{slides[Number(slide) - 2].title}</Text>
                    <Text className="text-xl text-typography-600 mt-4 text-center">{slides[Number(slide) - 2].subtitle}</Text>
                </View>
            </View>
        </View>
    )
